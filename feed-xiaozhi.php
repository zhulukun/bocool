...
$postlink   = '<br /><a href="' . get_permalink() . '">阅读原文</a><br /><br />';
...
>
  ...
  <!-- RSS feed defaults -->
    <channel>
        ...
        <!-- Feed Logo (optional) -->
        <image>
            <url><?php echo get_stylesheet_directory_uri() . '/images/logo.png'; ?></url>
            <title>
        ...
        <?php while( have_posts()) : the_post(); ?>
            ...
            <item>
                ...
                <link>
                     <?php the_permalink_rss(); ?><?php echo  '&amp;xiaozhi'; ?>
                </link>
                ...
                <pubDate><?php echo the_time("Y-m-d H:m:s");  ?></pubDate>
                <content>
