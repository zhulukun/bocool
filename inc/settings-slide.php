...
<div class="wrap">
	...
	<form method="post" id="table-form">
		...
		<p><?php printf(__( '小提示：为了保证最佳的用户体验，请以 750px 作为图片宽度，同一组的图片采用一致高度，图片编辑完成后使用压缩工具压缩以提升加载速度，如 %1$s 可减少图片 70%% 体积。如果你不能保证图片的尺寸和质量，那么我们不建议你使用幻灯片，糟糕的幻灯片会严重影响网站的美观性！', 'dmeng' ), '<a href="https://tinypng.com/" target="_blank">TinyPNG</a>');?></p>
<?php
