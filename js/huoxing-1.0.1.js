...
$(document).on("click","#hx-featured-image a#hx-featured-image-link",function(e){
		...
		custom_uploader.on('select', function() {
            ...
            jQuery('#hx-featured-image input#hx-featured-image-id').val(attachment.id);
	        ...
	        $.ajax({
				...
				data: {
					...
					action: 'hx_fetch_featured_image',
				...
				success:function(data, textStatus, XMLHttpRequest){
					...
					$('#hx-featured-image-container').html(data);
